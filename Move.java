...
class Move {
    ...
    static boolean isClone(String location0, String location1) {
        ...
        char c0, r0, c1, r1;
        c0 = location0.charAt(0);
        r0 = location0.charAt(1);
        c1 = location1.charAt(0);
        r1 = location1.charAt(1);


        return (Math.abs(c0 - c1) <= MAX_CLONE_NUM &&
                Math.abs(r0 - r1) <= MAX_CLONE_NUM);
    }
    ...
    static boolean isJump(String location0, String location1) {
        ...
        return (!isClone(location0, location1) &&
                Math.abs(c0 - c1) <= MAX_JUMP_NUM &&
                Math.abs(r0 - r1) <= MAX_JUMP_NUM);
    }
     ...
     * max clone num
     */
    private static final int MAX_CLONE_NUM = 1;

    /**
     * max jump num
     */
    private static final int MAX_JUMP_NUM = 2;
